(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))n(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function l(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(o){if(o.ep)return;o.ep=!0;const r=l(o);fetch(o.href,r)}})();const y="https://conference-tracker-production.up.railway.app";function b(){return localStorage.getItem("ct_token")}function x(t){localStorage.setItem("ct_token",t)}function h(){localStorage.removeItem("ct_token")}async function v(t){const e=await fetch(`${y}/api/auth/me`,{headers:{Authorization:`Bearer ${t}`}});return e.ok?e.json():null}class k extends HTMLElement{connectedCallback(){this.innerHTML=`
    <header>
        ...
        `,this.highlightActiveLink(),document.addEventListener("DOMContentLoaded",()=>{var e;(e=document.getElementById("users-nav-link"))==null||e.addEventListener("click",l=>{l.preventDefault(),E()})})}highlightActiveLink(){const e=window.location.pathname;this.querySelectorAll(".nav-links a").forEach(n=>{const o=n.getAttribute("href"),r=e.split("/").pop()||"index.html";o.replace("./","").split("?")[0]===r?n.classList.add("active"):n.classList.remove("active")})}}class I extends HTMLElement{connectedCallback(){this.innerHTML=`
        <footer>
    ...
    `,document.body.appendChild(t);let e="login";function l(n){e=n;const o=document.getElementById("ct-tab-login"),r=document.getElementById("ct-tab-register"),i=document.getElementById("ct-auth-submit"),a=document.getElementById("ct-password");n==="login"?(o.style.color="#3b82f6",o.style.borderBottomColor="#3b82f6",r.style.color="#64748b",r.style.borderBottomColor="transparent",i.textContent="Sign In",a.placeholder=""):(r.style.color="#3b82f6",r.style.borderBottomColor="#3b82f6",o.style.color="#64748b",o.style.borderBottomColor="transparent",i.textContent="Create Account",a.placeholder="At least 6 characters"),document.getElementById("ct-auth-error").style.display="none"}document.getElementById("ct-tab-login").addEventListener("click",()=>l("login")),document.getElementById("ct-tab-register").addEventListener("click",()=>l("register")),t.addEventListener("click",n=>{n.target===t&&m()}),document.getElementById("ct-auth-cancel").addEventListener("click",m),document.getElementById("ct-pending-close").addEventListener("click",m),document.getElementById("ct-logout-btn").addEventListener("click",()=>{h(),u(null),f(null),m()}),document.getElementById("ct-auth-form").addEventListener("submit",async n=>{n.preventDefault();const o=document.getElementById("ct-email").value,r=document.getElementById("ct-password").value,i=document.getElementById("ct-auth-error"),a=document.getElementById("ct-auth-submit");i.style.display="none",a.disabled=!0,a.textContent="Please wait...";try{const g=await fetch(`${y}${e==="login"?"/api/auth/login":"/api/auth/register"}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:o,password:r})}),s=await g.json();g.ok?s.pending?(document.getElementById("ct-auth-form").style.display="none",document.getElementById("ct-auth-tabs").style.display="none",document.getElementById("ct-pending-text").textContent=s.message,document.getElementById("ct-pending-msg").style.display="block"):(x(s.token),u(s.user),f(s.user),m()):(i.textContent=s.error||"Something went wrong.",i.style.display="block")}catch{i.textContent="Network error. Please try again.",i.style.display="block"}finally{a.disabled=!1,l(e)}})}function E(){const t=document.getElementById("ct-auth-modal");if(!t)return;const e=b(),l=document.getElementById("ct-auth-form"),n=document.getElementById("ct-logged-in"),o=document.getElementById("ct-auth-tabs"),r=document.getElementById("ct-pending-msg");l.style.display="",n.style.display="none",r.style.display="none",o.style.display="",document.getElementById("ct-auth-error").style.display="none",document.getElementById("ct-email").value="",document.getElementById("ct-password").value="",e&&v(e).then(i=>{i&&(document.getElementById("ct-logged-email").textContent=i.email,l.style.display="none",o.style.display="none",n.style.display="block")}),t.style.display="flex"}function m(){const t=document.getElementById("ct-auth-modal");t&&(t.style.display="none")}let d=null,c=null;function p(t,e,l){const n=document.createElement("a");return n.href=t,n.target="_blank",n.rel="noopener noreferrer",n.textContent=e,n.style.cssText=`
        display: block;
        margin-top: ${l};
    ...
    `,n.addEventListener("mouseenter",()=>{n.style.background="#e8e8e8",n.style.color="#1d4ed8",n.style.textDecoration="underline"}),n.addEventListener("mouseleave",()=>{n.style.background="#f5f5f5",n.style.color="#444",n.style.textDecoration="none"}),n}function u(t){const e=document.querySelector(".university-logo");e&&(t?(d||(d=p("/conferences/","Conference Tracker","2rem"),e.insertAdjacentElement("afterend",d)),!c&&(t.role==="owner"||t.role==="admin")&&(c=p("/pr-tool.html","PR Tool","0.5rem"),d.insertAdjacentElement("afterend",c))):(d&&(d.remove(),d=null),c&&(c.remove(),c=null)))}function f(t){const e=document.getElementById("users-nav-link");e&&(e.textContent=t?`${t.email.split("@")[0]} ▾`:"Users")}document.addEventListener("DOMContentLoaded",async()=>{B(),setTimeout(()=>{var e;(e=document.getElementById("users-nav-link"))==null||e.addEventListener("click",l=>{l.preventDefault(),E()})},0);const t=b();if(t){const e=await v(t);e?(u(e),f(e)):h()}});
